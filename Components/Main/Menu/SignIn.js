...
import iconOrder from '../../../Image/order.png';
import iconInfor from '../../../Image/infor.png';
import iconAbout from '../../../Image/about.png';
import iconSignOut from '../../../Image/signout.png';
...
class SignIn extends Component {
  ...
  render() {
    ...
    const { button, buttonText, profileBody, textStyle, icon } = styles;
    return (
