...
export const ROUTE_HOME = createStackNavigator({
...
export const ROUTE_CART = createStackNavigator({
    CART:{screen: Cart, navigationOptions:{header:null}},
    PRODUCTDETAIL:{screen: ProductDetail, navigationOptions:{header:null}},    
})
export const ROUTE_SEARCH = createStackNavigator({
    SEARCH:{screen: Search, navigationOptions:{header:null}},
    PRODUCTDETAIL:{screen: ProductDetail, navigationOptions:{header:null}},
})
export const ROUTE_CONTACT = createStackNavigator({
...
export const TABNAV = createBottomTabNavigator(
    {                             
        ...
        tabCart: {
            screen: ROUTE_CART,
            navigationOptions:{
                tabBarIcon: ({focused})=> <View style={{marginLeft: -width/30}}><IconCart focused={focused}/></View>,
                tabBarLabel: ({focused, tintColor})=> 
...
export const TABBAR = createAppContainer(TABNAV);
